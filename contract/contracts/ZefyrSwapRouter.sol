...
// @dev interface for interacting with an ZefyrSwap executor
interface IZefyrSwapExecutor {
...
contract ZefyrSwapRouter is Ownable {
    ...
    returns (uint256 amountOut)
  {
    ...
    // Delegate the execution of the path to the specified ZefyrSwap Executor
    uint256[] memory amountsIn = new uint256[](1);
    amountsIn[0] = tokenInfo.inputAmount;

    IZefyrSwapExecutor(executor).executePath{value: msg.value}(pathDefinition, amountsIn, msg.sender);
    ...
    returns (uint256[] memory amountsOut)
  {
    ...
    // Delegate the execution of the path to the specified ZefyrSwap Executor
    IZefyrSwapExecutor(executor).executePath{value: 0}(pathDefinition, amountsIn, msg.sender);
